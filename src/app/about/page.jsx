          ...
          <RevealWrapper className="load-hidden" id="about" delay={300}>
            ...
            >
              ...
              <Box textAlign="justify">
                ...
                <br />
                <Text>
                  I&apos;m <span className="name">Sanjay Raj</span>, a passionate
                  Software Engineer. I specialize in{" "}
                  <span className="tech">Software Application Design & Development</span>, crafting
                  seamless user experiences and robust backend solutions. With a
                  knack for problem-solving, I thrive on creating elegant code
                  that makes an impact. I always keep exploring new tools and
                  techniques to stay at the forefront of the ever-evolving tech
                  landscape.
                </Text>
                <br />
                <Text>
                  📫 Open to collaborations and exciting projects & opportunities, I&apos;m
