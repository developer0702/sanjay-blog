...
const Blogs = () => {
  ...
  const activeCardBrief = useMemo(() => {
    // article brief from hashnode, is not completely full it gives ... at end so we have fixed the issue by omitting the string
      ...
      <Center my={5}>
        ...
        >
          ...
          <ModalContent>
            <ModalHeader>
              <Link
                href={`https://www.linkedin.com/in/sanjay-raj-dev/${activeCard?.slug}`}
                target="_blank"
              >
                {activeCard?.title}
              </Link>
